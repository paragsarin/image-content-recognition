...
⚙️ .NET Core API – Handles image/question requests and communicates with the LLaVA model

🧠 LLaVA via Ollama – Leverages the power of a local vision-language model for inference

🔍 Use Case Fit – Ideal for exploring damage analysis in property and auto accident claims, useful in the P&C insurance domain
